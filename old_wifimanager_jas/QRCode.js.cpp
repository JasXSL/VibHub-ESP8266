...
const char QRCodeJS[] PROGMEM = "function QR8bitByte(t){"
	"this.mode=QRMode.MODE_8BIT_BYTE,this.data=t,this.parsedData=[];"
	"for(var e=0,r=this.data.length;e<r;e++){"
		"var o=[],n=this.data.charCodeAt(e);"
		"n>65536?(o[0]=240|(1835008&n)>>>18,o[1]=128|(258048&n)>>>12,o[2]=128|(4032&n)>>>6,o[3]=128|63&n):n>2048?(o[0]=224|(61440&n)>>>12,o[1]=128|(4032&n)>>>6,o[2]=128|63&n):n>128?(o[0]=192|(1984&n)>>>6,o[1]=128|63&n):o[0]=n,this.parsedData.push(o)}this.parsedData=Array.prototype.concat.apply([],this.parsedData),this.parsedData.length!=this.data.length&&(this.parsedData.unshift(191),this.parsedData.unshift(187),this.parsedData.unshift(239))"
	"}"
	...
	"function QRCode(t){"
		...
		"}"
		"if(this.options={padding:4,width:256,height:256,typeNumber:4,color:'#000',background:'#fff',ecl:'M'},'string'==typeof t&&(t={content:t}),t)"
			"for(var r in t)this.options[r]=t[r];"
			"var o=this.options.content,n=function(t,r){"
				"for(var o=e(t),n=1,i=0,a=0,s=QRCodeLimitLength.length;a<=s;a++){"
					"var h=QRCodeLimitLength[a];if(!h)throw new Error();"
					"switch(r){"
						"case\"L\":i=h[0];break;"
						"case\"M\":i=h[1];break;"
						"case\"Q\":i=h[2];break;"
				...
				"return n"
			"}"
			"(o,this.options.ecl),i=function(t){"
				"switch(t){"
			...
			"}"
			"(this.options.ecl);"
			"this.qrcode=new QRCodeModel(n,i),this.qrcode.addData(o),this.qrcode.make()"
		"}"
				...
				"for(6==a&&a--;;){"
					"for(var s=0;s<2;s++)"
						"if(null==this.modules[o][a-s]){"
							"var h=!1;i<t.length&&(h=1==(t[i]>>>n&1)),QRUtil.getMask(e,o,a-s)&&(h=!h),this.modules[o][a-s]=h,-1==--n&&(i++,n=7)"
						"}
	...
	"QRCodeModel.PAD0=236,QRCodeModel.PAD1=17,QRCodeModel.createData=function(t,e,r){"
		...
		"}"
		"for(var s=0,i=0;i<o.length;i++)s+=o[i].dataCount;"
		"if(n.getLengthInBits()>8*s)throw new Error();"
		"for(n.getLengthInBits()+4<=8*s&&n.put(0,4);n.getLengthInBits()%8!=0;)n.putBit(!1);"
		"for(;;){"
			"if(n.getLengthInBits()>=8*s)break;"
			"if(n.put(QRCodeModel.PAD0,8),n.getLengthInBits()>=8*s)break;"
	...
	"QRCodeModel.createBytes=function(t,e){"
		"for(var r=0,o=0,n=0,i=new Array(e.length),a=new Array(e.length),s=0;s<e.length;s++){"
			"var h=e[s].dataCount,u=e[s].totalCount-h;o=Math.max(o,h),n=Math.max(n,u),i[s]=new Array(h);"
			"for(c=0;c<i[s].length;c++)"
				"i[s][c]=255&t.buffer[c+r];"
			"r+=h;"
			"var l=QRUtil.getErrorCorrectPolynomial(u),g=new QRPolynomial(i[s],l.getLength()-1).mod(l);"
			"a[s]=new Array(l.getLength()-1);"
			"for(c=0;c<a[s].length;c++){"
				"var d=c+g.getLength()-a[s].length;a[s][c]=d>=0?g.get(d):0"
			"}"
		"}"
		"for(var f=0,c=0;c<e.length;c++)"
			"f+=e[c].totalCount;"
		"for(var R=new Array(f),Q=0,c=0;c<o;c++)"
			"for(s=0;s<e.length;s++)"
				"c<i[s].length&&(R[Q++]=i[s][c]);"
			"for(c=0;c<n;c++)"
				"for(s=0;s<e.length;s++)"
					"c<a[s].length&&(R[Q++]=a[s][c]);"
		"return R"
	"};"
	"for(var QRMode={MODE_NUMBER:1,MODE_ALPHA_NUM:2,MODE_8BIT_BYTE:4,MODE_KANJI:8},QRErrorCorrectLevel={L:1,M:0,Q:3,H:2},QRMaskPattern={PATTERN000:0,PATTERN001:1,PATTERN010:2,PATTERN011:3,PATTERN100:4,PATTERN101:5,PATTERN110:6,PATTERN111:7},QRUtil={PATTERN_POSITION_TABLE:[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],G15:1335,G18:7973,G15_MASK:21522,getBCHTypeInfo:function(t){"
		"for(var e=t<<10;QRUtil.getBCHDigit(e)-QRUtil.getBCHDigit(QRUtil.G15)>=0;)"
			"e^=QRUtil.G15<<QRUtil.getBCHDigit(e)-QRUtil.getBCHDigit(QRUtil.G15);return(t<<10|e)^QRUtil.G15_MASK"
	"},"
	...
	"getMask:function(t,e,r){"
		"switch(t){"
			"case QRMaskPattern.PATTERN000:return(e+r)%2==0;"
			"case QRMaskPattern.PATTERN001:return e%2==0;"
			"case QRMaskPattern.PATTERN010:return r%3==0;"
			"case QRMaskPattern.PATTERN011:return(e+r)%3==0;"
			"case QRMaskPattern.PATTERN100:return(Math.floor(e/2)+Math.floor(r/3))%2==0;"
			"case QRMaskPattern.PATTERN101:return e*r%2+e*r%3==0;"
			"case QRMaskPattern.PATTERN110:return(e*r%2+e*r%3)%2==0;"
			"case QRMaskPattern.PATTERN111:return(e*r%3+(e+r)%2)%2==0;"
	...
	"getLengthInBits:function(t,e){"
		"if(1<=e&&e<10)"
			"switch(t){"
				...
				"case QRMode.MODE_8BIT_BYTE:case QRMode.MODE_KANJI:return 8;"
				"default:throw new Error(t)}"
		"else if(e<27)"
			"switch(t){"
